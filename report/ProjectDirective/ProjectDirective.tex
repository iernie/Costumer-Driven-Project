...
\begin{itemize}
\item \textbf{Meetings:} Meetings are to be called by e-mail 24 hours prior to the meeting. The invitation should include an agenda as well as any other documents relevant to the discussion.
\item \textbf{Meeting Minutiae:} The project leader is responsible for assigning the task of taking minutiae at meetings. The minutiae are to be made available at the document repository within a 24 hours of the meeting.
\end{itemize}
