...
Date of completion & November 17th \\ [3pt] \hline
			...
			Steps executed & 	\begin{enumerate}
							...
							\begin{enumerate}
								\item Checked all the checkboxes individually
								\item Opened the all the dropdown menus and selected an option
								\item Chose a file for all the options with the "set" button
								\item Clicked the "x" to close the configuration editor
							...
							\item Resized the windows
							\begin{enumerate}
								\item Attempted to resize the main window
								\item Attempted to resize the configuration editor window
							\end{enumerate}
						\end{enumerate} \\ [3pt] \hline
			...
			Expected results &	\begin{enumerate}
							...
							\item  
							\begin{enumerate}
								\item Menu for changing configuration values is opened
								\item The specified database is loaded and used instead of the database loaded on startup
...
Date of completion & November 1st \\ [3pt] \hline
			...
			Steps executed & 	\begin{enumerate}
							...
							\item Created a JUnit Conclusion_Simple. This test is checking if the algorithm is giving the correct recommendation based on the k nearest policies found in step 5, and that the confidence has the correct value
						\end{enumerate} \\ [3pt] \hline
