...
\subsection{Documents and Source Code Repositories}\index{GitHub}
...
\subsection{Programming Languages}\index{Java}
...
\subsection{Databases}\index{MySQL}\index{CouchDB} %Assuming [Discuss community server here] is actually done here
...
\subsubsection{Third Party CBR System}\index{jColibri}
...
\subsubsection{Third Party k Nearest Neighbors Implementations}\index{The Java Machine Learning Library (JavaML)} 
...
\subsubsection{P3P/XML Parser}\index{P3P XML parsers}\index{P3P XML parsers!DOM}\index{P3P XML parsers!SAX}
...
\section{Standards}\index{Oracle's Coding Conventions}
...
<<<<<<< HEAD
\subsubsection{P3P Policy Objects}\index{P3P}
=======
...
>>>>>>> da740c988e5b599cd412b83d7260e8cabc60ef87
