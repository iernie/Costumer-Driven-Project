...
This is the project report for the course TDT4290 - Customer Driven Project, for the project "Privacy Advisor". The "Privacy Advisor" software is developed as part of a larger project for SINTEF ICT, researching the applicability of machine learning to aiding users in Internet privacy decisions. Previous research at SINTEF points out several advantages to using a Case Based Reasoning agent as a core in this type of application, which is the approach followed in this project. 

Since the software product to be delivered is a very early prototype that is to be used in further research, which indicates a strong design focus due to the likelihood of future extensions by the customer, a waterfall development model is selected. The overall goal as understood in the preliminary research phase is to develop a software prototype for further research in the applicability of case based reasoning as a basis for providing users advice with respect to Internet privacy
decision. 

The report is laid out in a chronological fashion according to the project plan, describing each phase of the software development process. Since this project is work-in-progress, this report is an outline, where the project directive, preliminary research and planning phases are detailed.
