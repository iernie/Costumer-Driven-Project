...
%% REMOVE INDEX IF THIS SECTION IS MOVED
...
\index{Distance metrics}\index{Distance metrics!Manhattan}\index{Distance metrics!Hamming}\index{Distance metrics!Levenshtein}\index{Distance metrics!Ontology}
=======
...
<<<<<<< HEAD
\subsection{Local Database}\index{Datastorage}\index{Datastorage!Local database}
=======
...
<<<<<<< HEAD
\subsection{Remote Databases}\index{Datastorage!Community database}  %network is going here
=======
...
\subsection{GUI} \index{Interfaces}\index{Interfaces!Graphical user interface (GUI)} %%TODO Einar
