...
\begin{center}
	...
	\caption{Test case for UNIT-01}\\ \hline
...
\begin{center}
	\begin{longtable}{ | p{4cm} | p{10cm} | }
	\caption{Test case for UNIT-02}\\ \hline
	\textbf{Item} & \textbf{Description} \\ [3pt] \hline \hline
	\endfirsthead
	\multicolumn{2}{c}%
	{\tablename\ \thetable\ -- \textit{Continued from previous page}} \\ \hline
...
\begin{center}
	\begin{longtable}{ | p{4cm} | p{10cm} | }
	\caption{Test case for UNIT-03}\\ \hline
	\textbf{Item} & \textbf{Description} \\ [3pt] \hline \hline
	\endfirsthead
	\multicolumn{2}{c}%
	{\tablename\ \thetable\ -- \textit{Continued from previous page}} \\ \hline
...
\begin{center}
	\begin{longtable}{ | p{4cm} | p{10cm} | }
	\caption{Test case for UNIT-04}\\ \hline
	\textbf{Item} & \textbf{Description} \\ [3pt] \hline \hline
	\endfirsthead
	\multicolumn{2}{c}%
	{\tablename\ \thetable\ -- \textit{Continued from previous page}} \\ \hline
...
\begin{center}
	\begin{longtable}{ | p{4cm} | p{10cm} | }
	\caption{Test case for UNIT-05}\\ \hline
	\textbf{Item} & \textbf{Description} \\ [3pt] \hline \hline
	\endfirsthead
	\multicolumn{2}{c}%
	{\tablename\ \thetable\ -- \textit{Continued from previous page}} \\ \hline
...
\begin{center}
	\begin{longtable}{ | p{4cm} | p{10cm} | }
	\caption{Test case for UNIT-06}\\ \hline
	\textbf{Item} & \textbf{Description} \\ [3pt] \hline \hline
	\endfirsthead
	\multicolumn{2}{c}%
	{\tablename\ \thetable\ -- \textit{Continued from previous page}} \\ \hline
...
\begin{center}
	\begin{longtable}{ | p{4cm} | p{10cm} | }
	\caption{Test case for UNIT-07}\\ \hline
	\textbf{Item} & \textbf{Description} \\ [3pt] \hline \hline
	\endfirsthead
	\multicolumn{2}{c}%
	{\tablename\ \thetable\ -- \textit{Continued from previous page}} \\ \hline
