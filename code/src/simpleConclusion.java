 ...
 * @version 29.09.11.1
 */
public class simpleConclusion extends ConclusionAlgorithm {
	 ...
	 */
	public simpleConclusion(DistanceMetric distanceMetric)
	{
	 ...
	 * @param knearestns the reduced set of neighbors
	 * @return an arraylist of {Action a, double Confidence) 
	 *
	 */
	public Action conclude(PolicyObject np, ArrayList<PolicyObject> knearestns)
	{
